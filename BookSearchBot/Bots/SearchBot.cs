    ...
    public class SearchBot : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            if (inputResponse != null)
            {
                ...
                var heroItems = inputResponse.Search.Results.Take(3);

                var heroCards = heroItems.Select(i => new HeroCard
                {
                    Images = new[] { new CardImage { Url = i.ImageUrl} }, //picture of book
                    Title = i.Title,//book name
                    Subtitle = i.Author//author
                });
